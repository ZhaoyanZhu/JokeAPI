...
app.get("/jokes/:id",(req,res)=>{
  let jokeIndex=parseInt(req.params.id);
  let joke=jokes.find((joke)=>joke.id===jokeIndex);
  res.json(joke);
})
...
app.get("/filter",(req,res)=>{
  ...
  let output=jokes.filter((joke)=>joke.jokeType==jokeType);
  res.json(output);
});
...
app.patch("/jokes/:id",(req,res)=>{
  let jokeID=parseInt(req.params.id);
  let joke=jokes.find((joke)=>joke.id===jokeID);
  const modifiedJoke={
    id:jokeID,
...
app.delete("/jokes/:id",(req,res)=>{
  ...
  if (jokeIndex>-1){
    ...
    res.status(404).json("Joke ID is not found!");
  }
})
...
app.delete("/all",(req,res)=>{
  ...
  if (APIKey==masterKey){
    ...
    res.status(401).json("You are unauthorized to perform this action!");
  }
})
...
var jokes = [
  ...
  {
    id: 101,
    jokeText: "This is a funny joke! You should laugh!!",
    jokeType: "Cold",
  },
];
